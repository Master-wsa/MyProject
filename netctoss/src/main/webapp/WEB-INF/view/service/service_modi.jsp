            ...
            //保存成功的提示信息
             function showResult() {
                 ...
                 $("#save_result_info").attr("class","save_success");
 				 $("#save_result_info").show().delay(1000).hide(500);
        ...
        <div id="main">
            ...
            <form action="${pageContext.request.contextPath}/service/modifyOverService.do" method="post" class="main_form">
                ...
                <div class="button_info clearfix">
                    ...
                    <button type="button" class="btn btn-primary" style="height:36px;width:100px;font-size:18px" onclick="showResult();submit()" >&nbsp;&nbsp;保&nbsp;&nbsp;存&nbsp;&nbsp;</button>
