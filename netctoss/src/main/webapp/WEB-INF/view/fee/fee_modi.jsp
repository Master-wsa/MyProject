	        		...
	        		$("#fname").focus(function(){
			       	...
			       	$("#add123").click(function(){
			       		...
			       		if(t1=="yes"&&t2=="yes"&&t3=="yes"&&t4=="yes"&&t5=="yes"){
			       		    ...
			       		    $.ajax({
			          			url:"${pageContext.request.contextPath}/fee/updateFee.do",
			          			type:"POST",
			          			data:{"fee_id":fee_id,"fee_name":fee_name,"fee_time":fee_time,"fee_bfee":fee_bfee,"fee_ufee":fee_ufee,"fee_des":fee_des,"fee_type":fee_type},
			          			success:function(reportList){
			          				if(reportList=="yes"){
			          					 $("#save_result_info").text("修改成功！");
		                                 $("#save_result_info").attr("class","save_success");
		                				 $("#save_result_info").show().delay(1000).hide(300);
		                				 /* $(location).attr("href","${pageContext.request.contextPath}/fee/getAllFee.do") */
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="${pageContext.request.contextPath }/fee/updateFee.do" method="post" class="main_form" id="add">
                ...
                <div class="input_info"><input name="fee_id" type="text" class="readonly" readonly value="${fee.fee_id }" id="fid"/></div>
                ...
                <div class="input_info" id="month2">
                    ...
                    <div class="validate_msg_long error_msg" id="ftimetip1" name="yes"  style="display:none;width: 420px;"></div>
                ...
                <div class="input_info"  id="bas2">
                    ...
                    <div class="validate_msg_long error_msg" id="bfeetip1" name="yes"   style="display:none;width: 420px;"></div>
                ...
                <div class="input_info" id="unit2">
                   ...
                   <div class="validate_msg_long error_msg1" id="ufeetip" style="display:none; width: 420px;">1-99999.99之间的数值</div>
                    <div class="validate_msg_long error_msg" id="ufeetip1"  name="yes"  style="display:none; width: 420px;"></div>
                ...
                <div class="button_info clearfix">
                    ...
                    <button type="button" class="btn btn-primary" style="height:36px;width:100px;font-size:18px" id="add123" >&nbsp;&nbsp;保&nbsp;&nbsp;存&nbsp;&nbsp;</button>
